...
export default async function SettingsPage({ params, searchParams }: Props) {
  ...
  else if (!lineStatus?.linked) lineReminderStatus = "unlinked";
  else if (!lineStatus.reminderOptIn) lineReminderStatus = "off";
  else if (!lineStatus.reachable) lineReminderStatus = "unreachable";
